...
public let telegramPostboxSeedConfiguration: SeedConfiguration = {
    ...
    return SeedConfiguration(
        ...
        defaultMessageNamespaceReadStates: [
            ...
            Namespaces.Message.MonogramLocal: .idBased(maxIncomingReadId: 0, maxOutgoingReadId: 0, maxKnownId: 0, count: 0, markedUnread: false)
        ],
        chatMessagesNamespaces: Set([Namespaces.Message.Cloud, Namespaces.Message.Local, Namespaces.Message.SecretIncoming, Namespaces.Message.MonogramLocal]),
