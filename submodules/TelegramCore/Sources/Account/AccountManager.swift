...
private var declaredEncodables: Void = {
    ...
    declareEncodable(MonogramDeletedMessageAttribute.self, f: { MonogramDeletedMessageAttribute(decoder: $0) })
    declareEncodable(MonogramEditHistoryMessageAttribute.self, f: { MonogramEditHistoryMessageAttribute(decoder: $0) })
