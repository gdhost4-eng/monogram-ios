...
private let accountAuxiliaryMethods = AccountAuxiliaryMethods(configurePostbox: setupMonogramMessagePreservation, fetchResource: { account, resource, ranges, _ in
    return nil
